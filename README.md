```
  _                   ____             _                  _______          _ 
 | |                 |  _ \           | |                |__   __|        | |
 | |     ___   __ _  | |_) | __ _  ___| | ___   _ _ __      | | ___   ___ | |
 | |    / _ \ / _` | |  _ < / _` |/ __| |/ / | | | '_ \     | |/ _ \ / _ \| |
 | |___| (_) | (_| | | |_) | (_| | (__|   <| |_| | |_) |    | | (_) | (_) | |
 |______\___/ \__, | |____/ \__,_|\___|_|\_\\__,_| .__/     |_|\___/ \___/|_|
               __/ |                             | |                         
              |___/                              |_|                         
```                          
...
- Archives are named with the current date and time
...
```bash
git clone https://github.com/edimurg/log.archive.tool.git
```
```bash
cd Log_Backup_tool
```
